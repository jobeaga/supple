...
<input type=hidden name="{{name}}" value="{{value}}" id="{{id}}">', 'js_edittemplate' => '<select name="{{name}}" id="{{id}}"> {{#xif " this.view == &#039;2&#039; "}} </option><option value="" {{#xif " this.value == &#039;&#039; "}}selected{{/xif}}> </option> {{/xif}}  <option value="1" {{#xif " this.value == &#039;1&#039; "}}selected{{/xif}}> {{lang.LBL_YES}}  </option><option value="0" {{#xif " this.value == &#039;0&#039; "}}selected{{/xif}}> {{lang.LBL_NO}} </option></select>')
