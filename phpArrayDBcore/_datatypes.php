...
<input type=hidden name="$_name" value="$_htmlentities(")[$_value]" id="$_name">', 'edittemplate' => '<input type=text size="$size" name="$_name" value="$_htmlentities(")[$_value]" id="$_name">', 'date_modified' => '2020-04-28 02:15', 'modified_by' => 1, 'js_viewtemplate' => '{{value}} <input type="hidden" name="{{name}}" id="{{id}}" value="{{value}}">', 'js_edittemplate' => '<input type="text" {{#xif " this.view == &#039;2&#039; && this.f.size > 19 "}}{{else}}size="{{f.size}}"{{/xif}} name="{{name}}" id="{{id}}" value="{{value}}"> ', 'search_ops' => '', 'search_ops_1' => '1', 'search_ops_2' => '2', 'search_ops_3' => '3', 'search_ops_4' => '4', 'search_ops_5' => '5', 'search_ops_6' => '10', 'search_ops_7' => '11')
...
<input type=hidden name="$_name" value="$_htmlentities(")[$_value]" id="$_name">', 'edittemplate' => '<textarea cols=50 rows=$($f.size)[$f.size][6] name="$_name" id="$_name">$_value</textarea>', 'metatemplate' => '<label class=view>Rows:</label> <input type=text size=5 name=size value="$r.size"><br>', 'id' => 2, 'date_modified' => '2017-12-01 17:57', 'modified_by' => 1, 'js_viewtemplate' => '{{#xif " this.view == &#039;2&#039; "}}...{{else}}{{value}}{{/xif}} <input type="hidden" name="{{name}}" id="{{id}}" value="{{value}}">', 'js_edittemplate' => '<textarea cols="50" rows="{{f.size}}" name="{{name}}" id="{{id}}">{{value}}</textarea>')
, '2' => array('typename' => 'BooleanDropdown', 'viewtemplate' => '$($_value)[$_lang.LBL_YES][$_lang.LBL_NO]
<input type=hidden name="$_name" value="$_value" id="$_name">', 'edittemplate' => '<select name="$_name" id="$_name"><option value=1 $($_value)[selected]> $_lang.LBL_YES  </option><option value=0 $($_value)[][selected]> $_lang.LBL_NO </option></select>', 'metatemplate' => '', 'id' => 3, 'date_modified' => '2022-04-26 02:45', 'modified_by' => 1, 'js_viewtemplate' => '{{#xif " this.value == &#039;1&#039; "}}{{lang.LBL_YES}}{{else}}{{lang.LBL_NO}}{{/xif}}
<input type=hidden name="{{name}}" value="{{value}}" id="{{id}}">', 'js_edittemplate' => '<select name="{{name}}" id="{{id}}" class="boolean_dropdown"> {{#xif " this.view == &#039;2&#039; "}} </option><option value="" {{#xif " this.value == &#039;&#039; "}}selected{{/xif}}> </option> {{/xif}}  <option value="0" {{#xif " this.value == &#039;0&#039; "}}selected{{/xif}}> {{lang.LBL_NO}} </option><option value="1" {{#xif " this.value == &#039;1&#039; "}}selected{{/xif}}> {{lang.LBL_YES}}  </option></select>')
...
]', 'edittemplate' => '$($_value)[ <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=hidden name=$_name id=$_name value> $_lang.BTN_DELETE&#039;)" value="$_lang.BTN_REMOVE"> <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=file name=$_name id=$_name>&#039;)" value="$_lang.BTN_MODIFY"> ][<input type=file name="$_name" id="$_name">]', 'metatemplate' => '', 'id' => 5, 'assigned_user_id' => '', 'date_modified' => '2017-12-01 18:00', 'modified_by' => 1, 'js_viewtemplate' => '{{#xif " this.value != &#039;&#039; "}}<a href="admin.php?action=download&id={{record_id}}&field={{f.name}}&table={{table}}"> {{lang.LBL_DOWNLOAD}} </a>{{/xif}}', 'js_edittemplate' => '{{#xif " this.value != &#039;&#039; "}} <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=hidden name={{name}} id={{id}} value> {{lang.BTN_DELETE}}&#039;)" value="{{lang.BTN_REMOVE}}"> <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=file name={{name}} id={{id}}>&#039;)" value="{{lang.BTN_MODIFY}}"> {{else}} <input type=file name="{{name}}" id="{{id}}"> {{/xif}}')
...
<input type=hidden name="$_name" value="$_htmlentities(")[$_value]" id="$_name">', 'edittemplate' => '<input type="url" name="$_name" id="$_name" value="$_value" style="width:96%">', 'metatemplate' => '', 'id' => 10, 'date_modified' => '2019-04-18 14:28', 'modified_by' => 1, 'js_viewtemplate' => '{{#xif " this.value == &#039;&#039; "}}{{lang.LBL_NO_LINK}}{{else}}{{value}}{{/xif}} <input type="hidden" name="{{name}}" id="{{id}}" value="{{value}}">', 'js_edittemplate' => '<input type="url" name="{{name}}" id="{{id}}" value="{{value}}" style="width:96%">')
, '10' => array('typename' => 'ID Link', 'viewtemplate' => '<a href="$[$link]$($_get.view==2)[$e.id][$_get.id]" id="$_name">$_name</a>', 'edittemplate' => '<a href="$[$link]$($_get.view==2)[$e.id][$_get.id]" id="$_name">$_name</a>', 'metatemplate' => '<label class=view>Link:</label> <input type=text size=20 name=link value=><br>', 'id' => 11, 'assigned_user_id' => '', 'date_modified' => '2019-04-18 18:08', 'modified_by' => 1, 'js_viewtemplate' => '<a href="{{f.link}}{{record_id}}" id="{{id}}" target="_blank">{{name}}</a> <input type=hidden id="{{id}}"  value="{{f.link}}{{record_id}}">', 'js_edittemplate' => '<a href="{{f.link}}{{record_id}}" id="{{id}}" target="_blank">{{name}}</a> <input type=hidden id="{{id}}"  value="{{f.link}}{{record_id}}">')
...
<input type=hidden name="{{name}}" value="{{value}}" id="{{id}}">', 'js_edittemplate' => '{{#xif " this.view == &#039;2&#039; "}}<select name="{{name}}" id="{{id}}" class="boolean_dropdown">  </option><option value="" {{#xif " this.value == &#039;&#039; "}}selected{{/xif}}> </option> <option value="1" {{#xif " this.value == &#039;1&#039; "}}selected{{/xif}}> {{lang.LBL_YES}}  </option><option value="0" {{#xif " this.value == &#039;0&#039; "}}selected{{/xif}}> {{lang.LBL_NO}} </option></select>     {{else}}  <input type=hidden name="{{name}}" value=0>
...
</script>', 'metatemplate' => '<label class=view>Rows:</label> <input type=text size=5 name=size value=5><br>', 'id' => 16, 'date_modified' => '2019-04-20 00:48', 'modified_by' => 1, 'assigned_user_id' => '', 'js_viewtemplate' => '<span class="richtext" id="{{id}}_richtext"></span>
...
', 'metatemplate' => '', 'id' => 19, 'date_modified' => '2020-04-28 02:14', 'modified_by' => 1, 'search_ops' => '', 'search_ops_1' => '1', 'search_ops_2' => '8', 'search_ops_3' => '9', 'search_ops_4' => '6', 'search_ops_5' => '10', 'search_ops_6' => '11', 'search_ops_7' => '12', 'search_ops_8' => '13', 'search_ops_9' => '14')
...
});</script>', 'metatemplate' => '', 'id' => 20, 'date_modified' => '2019-04-18 16:32', 'modified_by' => 1, 'js_viewtemplate' => '    <span id="{{id}}"></span>
    <input type="hidden" value="{{value}}" id="_date_{{id}}" name="{{name}}">
    <script>
...
]', 'metatemplate' => '', 'id' => 25, 'date_modified' => '2020-04-28 02:33', 'modified_by' => 1, 'js_viewtemplate' => ' {{#xif " this.value != &#039;&#039; "}}<span id="{{id}}_{{f.id}}"></span><script> 
...
</script>', 'date_entered' => '2016-08-13 14:53', 'created_by' => '2', 'date_modified' => '2019-04-20 01:22', 'modified_by' => 1, 'id' => 27, 'js_viewtemplate' => '<div style="width:50px;height:24px;background-color: #{{value}};border:1px solid black; margin-top: 8px; margin-bottom: 8px;"></div>
...
<input type=hidden name="$_name" value="$_htmlentities(")[$_value]" id="$_name">', 'edittemplate' => '<textarea cols=50 rows=$($f.size)[$f.size][6] name="$_name" id="$_name">$_value</textarea>', 'metatemplate' => '<label class=view>Rows:</label> <input type=text size=5 name=size value="$r.size"><br>', 'id' => 2, 'date_modified' => '2020-11-05 13:17', 'modified_by' => 1, 'js_viewtemplate' => '{{#xif " this.view == &#039;2&#039; "}}...{{else}}<span style="white-space:pre-line;background-color:white;display:block;padding:8px;border-radius:5px;">{{value}}</span>{{/xif}} <input type="hidden" name="{{name}}" id="{{id}}" value="{{value}}">', 'js_edittemplate' => '<textarea cols="50" rows="{{f.size}}" name="{{name}}" id="{{id}}">{{value}}</textarea>', 'search_ops' => '', 'search_ops_1' => '2', 'search_ops_2' => '3', 'search_ops_3' => '4', 'search_ops_4' => '10', 'search_ops_5' => '11');
...
});</script>', 'metatemplate' => '', 'id' => 20, 'date_modified' => '2020-11-05 13:58', 'modified_by' => 1, 'js_viewtemplate' => '    <span id="{{id}}_{{f.id}}"></span>
    <input type="hidden" value="{{value}}" id="_date_{{id}}_{{f.id}}" name="{{name}}">
    <script>
...
<input type=hidden name="$_name" value="$_htmlentities(")[$_value]" id="$_name">', 'edittemplate' => '<textarea cols=50 rows=$($f.size)[$f.size][6] name="$_name" id="$_name">$_value</textarea>', 'metatemplate' => '<label class=view>Rows:</label> <input type=text size=5 name=size value="$r.size"><br>', 'id' => 2, 'date_modified' => '2021-01-21 03:48', 'modified_by' => 1, 'js_viewtemplate' => '<span class="textarea_view">{{value}}</span> <input type="hidden" name="{{name}}" id="{{id}}" value="{{value}}"><script>generateCopyButton("{{id}}")</script>', 'js_edittemplate' => '<textarea cols="50" rows="{{f.size}}" name="{{name}}" id="{{id}}">{{value}}</textarea> ', 'search_ops' => '', 'search_ops_1' => '2', 'search_ops_2' => '3', 'search_ops_3' => '4', 'search_ops_4' => '10', 'search_ops_5' => '11', 'search_ops_label' => '');
$_datatypes [] = array('typename' => 'FileUpload', 'viewtemplate' => '$_eval[ $_name . &#039;_size&#039;](=size_field)
$[$$size_field](=size) 
$($size > 0)[ 
<a href=admin.php?action=download&id=$record_id&field=$_name&table=$table> $_lang.LBL_DOWNLOAD </a>
]', 'edittemplate' => '$($_value)[ <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=hidden name=$_name id=$_name value> $_lang.BTN_DELETE&#039;)" value="$_lang.BTN_REMOVE"> <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=file name=$_name id=$_name>&#039;)" value="$_lang.BTN_MODIFY"> ][<input type=file name="$_name" id="$_name">]', 'metatemplate' => '', 'id' => 5, 'assigned_user_id' => '', 'date_modified' => '2021-01-14 14:15', 'modified_by' => 1, 'js_viewtemplate' => '{{#xif " this.value != &#039;&#039; "}}<a href="admin.php?action=download&id={{record_id}}&field={{f.name}}&table={{table}}"> {{lang.LBL_DOWNLOAD}} </a>{{/xif}}', 'js_edittemplate' => '{{#xif " this.value != &#039;&#039; "}} <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=hidden name={{name}} id={{id}} value> {{lang.BTN_DELETE}}&#039;)" value="{{lang.BTN_REMOVE}}"> <input type="button" onclick="jQuery(this).parent().html(&#039;<input type=file name={{name}} id={{id}}>&#039;)" value="{{lang.BTN_MODIFY}}"><input type="hidden" name="{{name}}" id="{{id}}" value="{{value}}" disabled="disabled"> {{else}} <input type=file name="{{name}}" id="{{id}}"> {{/xif}}
<script>
...
</script> ', 'search_ops' => '', 'date_entered' => '2021-01-21 02:07', 'created_by' => 1, 'date_modified' => '2021-01-21 03:51', 'modified_by' => 1, 'search_ops_1' => '2', 'search_ops_2' => '10', 'search_ops_3' => '11', 'id' => 28, 'search_ops_label' => '');
?><?php

$_datatypes [] = array('typename' => 'Bean Function', 'id' => 29, 'date_modified' => '2021-06-03 13:11', 'modified_by' => 1, 'js_viewtemplate' => '<span id="_bean_function_{{id}}">{{value}}</span><input type=hidden value="{{value}}" id="{{id}}"><script> getBeanFunctionData(\'{{table}}\', \'{{f.name}}\', \'{{record_id}}\', \'{{id}}\', \'{{value}}\'); </script>', 'js_edittemplate' => '{{#xif " this.record_id != &#039;&#039; "}}<span id="_bean_function_{{id}}">{{value}}</span><input type=hidden value="{{value}}" id="{{id}}"><script> getBeanFunctionData(\'{{table}}\', \'{{f.name}}\', \'{{record_id}}\', \'{{id}}\', \'{{value}}\'); </script>{{/xif}}');

?><?php

$_datatypes [] = array('typename' => 'Button', 'id' => 30, 'assigned_user_id' => '', 'date_modified' => '2026-02-23 13:42', 'modified_by' => 1, 'js_viewtemplate' => '<input type="button" onclick="{{f.js_code}}" record_id="{{record_id}}" id="{{id}}" value="{{f.label}}" class="{{f.name}}_view">', 'js_edittemplate' => '<input type="button" onclick="{{f.js_code}}" record_id="{{record_id}}" id="{{id}}" value="{{f.label}}" class="{{f.name}}_edit">');
